...
router.get('/profile', authMiddleware(), userController.getProfile); // Ruta protegida para obtener perfil
router.put('/update', authMiddleware(), userController.updateUser); // Ruta protegida para actualizar usuario
router.delete('/delete', authMiddleware(), userController.deleteUser); // Ruta protegida para eliminar usuario
...
router.delete('/clients/:id', authMiddleware(), clientController.deleteClient); // Eliminar un cliente 
...
router.delete('/services/:id', authMiddleware(), serviceController.deleteService); // Eliminar un servicio 
...
router.delete('/appointments/:id', authMiddleware(), appointmentController.deleteAppointment); // Eliminar una cita 
